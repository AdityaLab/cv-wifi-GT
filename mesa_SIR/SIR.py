...
<<<<<<< HEAD
def build_network(interactions, samllest_id, population, chaos = 0.001):
    G = nx.Graph()
    population_str = [str(smallest_id+ i) for i in range(population)]
=======
def build_network(interactions, population, chaos = 0.001):
    G = nx.Graph()
    population_str = [str(2001+ i) for i in range(population)]
>>>>>>> 77ad7b612dd99394432a358da9625cb4b92579cb
